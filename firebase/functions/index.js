...
exports.onIntegrationDelete = (0, firestore_1.onDocumentDeleted)({
    ...
    try {
        ...
        await Promise.all([
            (0, firestore_3.processBatch)(shelvesQuery, (batch, doc) => batch.delete(doc.ref), 'Deleting shelves'),
            (0, firestore_3.processBatch)(itemsQuery, (batch, doc) => batch.delete(doc.ref), 'Deleting items'),
        ]);
...
exports.refreshShelf = (0, https_1.onCall)(refreshShelfOptions, async (request) => {
