...
async function createTestUser(userId, data = {}) {
    await db
        .collection('users')
        .doc(userId)
        .set(Object.assign({ userId, createdAt: admin.firestore.FieldValue.serverTimestamp(), updatedAt: admin.firestore.FieldValue.serverTimestamp() }, data));
}
/**
...
async function createTestSource(sourceId, data = {}) {
    await db
        .collection('sources')
        .doc(sourceId)
        .set(Object.assign({ sourceId, createdAt: admin.firestore.FieldValue.serverTimestamp(), updatedAt: admin.firestore.FieldValue.serverTimestamp() }, data));
}
/**
...
async function createTestIntegration(integrationId, userId, sourceId, data = {}) {
    await db
        ...
        .doc(integrationId)
        .set(Object.assign({ integrationId,
        userId,
        sourceId, createdAt: admin.firestore.FieldValue.serverTimestamp(), updatedAt: admin.firestore.FieldValue.serverTimestamp() }, data));
}
/**
...
async function createTestShelf(shelfId, userId, sourceId, integrationId, data = {}) {
    await db
        .collection('shelves')
        .doc(shelfId)
        .set(Object.assign({ shelfId,
        userId,
        sourceId,
        integrationId, createdAt: admin.firestore.FieldValue.serverTimestamp(), updatedAt: admin.firestore.FieldValue.serverTimestamp() }, data));
}
/**
