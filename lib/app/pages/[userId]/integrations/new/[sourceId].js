...
exports.default = NewIntegration;
...
function NewIntegration() {
    ...
    const [sourceData, setSourceData] = (0, react_1.useState)(null);
    ...
    (0, react_1.useEffect)(() => {
        ...
        const fetchSourceData = async () => {
            try {
                const sourceDocRef = (0, firestore_1.doc)(firebase_1.db, 'sources', sourceId);
                const sourceDoc = await (0, firestore_1.getDoc)(sourceDocRef);
                if (sourceDoc.exists()) {
    ...
    const handleSave = async () => {
        try {
            ...
            await (0, firestore_1.runTransaction)(firebase_1.db, async (transaction) => {
                ...
                const newIntegrationRef = (0, firestore_1.doc)(integrationsRef);
                // Create the new integration document with the generated ID
                transaction.set(newIntegrationRef, Object.assign(Object.assign({}, sourceData), { // Inherit all fields from the source document
                    accountSlug, // Override with form input
                    myBooksURL, integrationId: newIntegrationRef.id, // Include the generated ID
                    userId, createdAt: (0, firestore_1.serverTimestamp)(), updatedAt: (0, firestore_1.serverTimestamp)() }));
            });
    ...
    return (<react_native_1.View style={styles.container}>
      ...
      <react_native_1.View style={styles.contentWrapper}>
        <react_native_1.ScrollView contentContainerStyle={styles.content}>
          <react_native_1.Text style={styles.title}>Create a new {sourceData.displayName} Integration</react_native_1.Text>
...
//# sourceMappingURL=%5BsourceId%5D.js.map